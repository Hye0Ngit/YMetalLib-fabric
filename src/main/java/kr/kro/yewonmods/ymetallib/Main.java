...
public class Main implements ModInitializer {
	...
	private static ConfiguredFeature<?, ?> ORE_TIN_DEEPSLATE = Feature.ORE
			.configure(new OreFeatureConfig(
					...
					8))
			.range(new RangeDecoratorConfig(
					UniformHeightProvider.create(YOffset.aboveBottom(-20), YOffset.fixed(0))))
			.spreadHorizontally()
			.repeat(5);
	...
	private static ConfiguredFeature<?, ?> ORE_SILVER_DEEPSLATE = Feature.ORE
			.configure(new OreFeatureConfig(
					...
					8))
			.range(new RangeDecoratorConfig(
					UniformHeightProvider.create(YOffset.aboveBottom(-30), YOffset.fixed(0))))
			.spreadHorizontally()
			.repeat(5);
	private static ConfiguredFeature<?, ?> ORE_PLATINUM_DEEPSLATE = Feature.ORE
			.configure(new OreFeatureConfig(
					...
					1))
			.range(new RangeDecoratorConfig(
					UniformHeightProvider.create(YOffset.aboveBottom(-64), YOffset.fixed(-48))))
			.spreadHorizontally()
			.repeat(1);
	private static ConfiguredFeature<?, ?> ORE_NICKEL_DEEPSLATE = Feature.ORE
			.configure(new OreFeatureConfig(
					...
					4))
			.range(new RangeDecoratorConfig(
					UniformHeightProvider.create(YOffset.aboveBottom(-36), YOffset.fixed(-8))))
			.spreadHorizontally()
			.repeat(3);
	...
	private static ConfiguredFeature<?, ?> ORE_TITANIUM_DEEPSLATE = Feature.ORE
			.configure(new OreFeatureConfig(
					...
					3))
			.range(new RangeDecoratorConfig(
					UniformHeightProvider.create(YOffset.aboveBottom(-64), YOffset.fixed(-36))))
			.spreadHorizontally()
			.repeat(3);
